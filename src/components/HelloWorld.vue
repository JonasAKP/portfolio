      ...
      <v-flex xs12 sm12 class="my-3" >
        <div class="text-xs-center">
          ...
          <p class="subheading font-weight-regular">
            For help and collaboration with other Vuetify developers, adadadawd adadadadadadadadad dadadadadadad adadadadda dadadadadadadada
            <br>please join our online lsjgfksejbgfl ksbflksbflkhs bflkhwsbflsfbs efbjlshfblk rhgfblkeRHG BLKerhgb lHBWGRF
          </p>
        </div>
      </v-flex>

      <v-flex xs12 sm12 id="web">
...
<v-flex xs12 sm12 id="media">
      ...
      <v-flex xs12 md4>
        <v-card class="elevation-0 transparent">
          ...
          <v-card-text>
            Cras facilisis mi vitae nunc lobortis pharetra. Nulla volutpat tincidunt ornare.
            Pellentesque habitant morbi tristique senectus et netus et ma lesuada fames ac turpis egestas.
            Nullam in aliquet odio. Aliquam eu est vitae tellus bibendum tincidunt. Suspendisse potenti.
          </v-card-text>
        </v-card>
      </v-flex>
